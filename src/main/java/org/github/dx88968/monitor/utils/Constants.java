...
public class Constants {
	...
	public static final int MAX_NUM_PIPELINE=100;
	public static final int MAX_NUM_SESSION_EACH_PIPELINE=10;
	public static final int MAX_THOURGHOUT=10000;
	public static final int SESSIONTIMEOUT=3;
	public static final int DEFAULTSERVERPORT=9002;
}
